...
public class ConsolaOlimpicos
{
	...
	{
		String atleta = input("Introduzca el nombre del atleta:");
		String pais_encontrado = calculadora.paisDeAtleta(atleta);
		System.out.println("El atleta es del pais: " + pais_encontrado);
	}
